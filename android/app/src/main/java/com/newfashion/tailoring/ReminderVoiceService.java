...
public class ReminderVoiceService extends Service
    ...
    public void onCreate() {
        ...
        Notification notification =
                createServiceNotification(
                        "நினைவூட்டல்",
                        "குரல் நினைவூட்டல் சேவை இயங்குகிறது"
                );
        try {
    ...
    public int onStartCommand(
        ...
        if (title == null ||
                title.trim().isEmpty()) {
            title = "New Fashion Tailoring";
        }
        if (message == null ||
                message.trim().isEmpty()) {
            Log.e(
                    TAG,
                    "REMINDER MESSAGE IS EMPTY"
            );
            stopSelf(startId);
            return START_NOT_STICKY;
        }
    ...
    private Notification createServiceNotification(
        ...
        /*
         * Remove UI-only summary/header lines first.
         */
        s = cleanReminderVoiceText(s);

        /*
         * Exact garment pronunciation.
         */
        s = s.replaceAll(
        ...
        /*
         * Known place-name pronunciation fixes.
         */
        s = s.replace(
                "Manthakudipatty",
                "மாந்தகுடிப்பட்டி"
        ...
        /*
         * Final voice-only cleanup:
         * no emoji, bell, clock, comma, colon,
         * exclamation/question mark, brackets,
         * slash, hyphen, quotes or other punctuation.
         */
        s = s.replaceAll(
                "[\\p{So}\\p{Sk}\\p{P}]+",
                " "
    ...
    private boolean isUiOnlyLine(
        ...
        ) && normalized.toLowerCase(Locale.ROOT).contains("order")) {
            return true;
        }
        if (normalized.contains(
                "நேரம்"
